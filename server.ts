...
export const getServer = (sessionMapping: Map<string, { apiKey: string; isPro: boolean }>) => {
  ...
  server.tool(
    ...
    async ({ nextToken }, ctx) => {
      ...
      const resp = await fetchLocalFalconReports(apiKey, limit, handleNullOrUndefined(nextToken));
  ...
  server.tool(
    ...
    async ({ startDate, endDate }, ctx) => {
      ...
      const limit = isProUser(ctx) ? HIGH_LIMIT : LOW_LIMIT;
      const resp = await fetchLocalFalconGuardReports(apiKey, limit, handleNullOrUndefined(startDate), handleNullOrUndefined(endDate));
      return { content: [{ type: "text", text: JSON.stringify(resp, null, 2) }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ nextToken, placeId, keyword }, ctx) => {
      ...
      const resp = await fetchLocalFalconTrendReports(apiKey, limit, handleNullOrUndefined(nextToken), handleNullOrUndefined(placeId), handleNullOrUndefined(keyword));
      return { content: [{ type: "text", text: JSON.stringify(resp, null, 2) }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ nextToken, placeId, keyword, grid_size, frequency, status }, ctx) => {
      ...
      const resp = await fetchLocalFalconAutoScans(apiKey, handleNullOrUndefined(nextToken), handleNullOrUndefined(placeId), handleNullOrUndefined(keyword), handleNullOrUndefined(grid_size), handleNullOrUndefined(frequency), handleNullOrUndefined(status));
      return { content: [{ type: "text", text: JSON.stringify(resp, null, 2) }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ placeId, keyword, nextToken }, ctx) => {
      ...
      const limit = isProUser(ctx) ? HIGH_LIMIT : LOW_LIMIT;
      const resp = await fetchLocalFalconLocationReports(apiKey, limit, handleNullOrUndefined(placeId), handleNullOrUndefined(keyword), handleNullOrUndefined(nextToken));
      return { content: [{ type: "text", text: JSON.stringify(resp, null, 2) }] };
    }
  );
  ...
  server.tool(
    ...
    async ({ nextToken, keyword }, ctx) => {
      ...
      const limit = isProUser(ctx) ? HIGH_LIMIT : LOW_LIMIT;
      const resp = await fetchLocalFalconKeywordReports(apiKey, limit, handleNullOrUndefined(nextToken), handleNullOrUndefined(keyword));
      return { content: [{ type: "text", text: JSON.stringify(resp, null, 2) }] };
    }
  );
